...
public class Cuerpo3 {
    ...
    public Cuerpo3(String username, String password, String responsable, String estadoCerrado) {
    ...
    public Cuerpo3(String username, String password, String responsable, String estadoCerrado, String faseIni, String faseFin, String asingnadoIni, String asingnadoFin) {
        this.username = username;
        this.password = password;
        this.responsable = responsable;
        this.estadoCerrado = estadoCerrado;
    ...
    public Cuerpo3(String username, String password, String responsable, String estadoCerrado, String mantIni, String mantFin) {
        this.username = username;
        this.password = password;
        this.responsable = responsable;
        this.estadoCerrado = estadoCerrado;
    ...
    //MANTENIMIENTO ASIGNADO Y FECHA SOLICITADA INICIAL


    public Cuerpo3(String username, String password, String responsable, String estadoCerrado, String mantIni, String mantFin, String asingnadoIni, String asingnadoFin, String fechaIni) {
        this.username = username;
        this.password = password;
        this.responsable = responsable;
        this.estadoCerrado = estadoCerrado;
