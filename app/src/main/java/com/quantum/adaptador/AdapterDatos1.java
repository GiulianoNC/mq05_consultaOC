...
public class AdapterDatos1 extends RecyclerView.Adapter<AdapterDatos1.ViewHolderDatos> implements View.OnClickListener{

    private View.OnClickListener listener;
    ArrayList<String> listDatos1;

    public AdapterDatos1(ArrayList<String> listDatos) {
        this.listDatos1 = listDatos;
    }
